...
export default function Whatsell() {
  return (
    ...
    <div className="flex flex-col items-center md:justify-center tablle ">
            ...
            <TableContainer className="mw-screen-lg TableContainer" component={Paper} sx={{ padding: "15px", minWidth: 1000 , maxWidth: 1500, boxShadow: '2px 1px 11px rgba(0, 0, 0, 0.226)' }}>
    ...
    <div className="flex flex-col items-center justify-center mt-24 tablle2 mb-11">
