...
const Navbar = () => {
    return (
        <div>
     <div className="flex items-center justify-between px-24 py-6 bg-white md:w-full navbar">
         <a className="logo" href="#">Muraadso</a>
         <nav className="flex items-center justify-between w-1/4 space-x-7 nav">
