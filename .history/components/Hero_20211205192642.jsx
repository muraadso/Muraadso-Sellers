    ...
    return (
        <div className="grid grid-cols-2 hero">
                <div className="px-16 py-20 herotxt">
                    ...
                    <p className="text-gray-800" >Whether you’ve already got an established ecommerce business, a great idea for a new product, or you just have a passion for selling, here’s how to take that next step with Muraadso</p>
                </div>
