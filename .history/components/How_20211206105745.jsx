export const How = () => {
    return (
        <div className="flex flex-col items-center justify-center mt-72 how mb-80">
            <div className="howheader">
            <h2 className="text-4xl font-bold text-center">Sidee u shaqaysaa</h2>
            <p className="mt-2 text-lg text-center text-gray-600">habka uu ushaqeeyo adeegan waa sidatan hoos ku xusan</p>
            </div>
            ...
            <p>Wixii faahfaahin ah waxaad kala xiriiri kartaa lambaradan hoos kuugu xusan</p>
            <a className="font-medium text-red-700" href="#">+252 63 3333471</a>
