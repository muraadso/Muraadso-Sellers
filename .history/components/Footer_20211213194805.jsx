...
const Footer = () => {
    return (
        ...
        <div className="subscribe items-center justify-center flex p-2 md:p-16 ">
            <div className="subcontainer bg-red-500 md:w-3/4 p-11 rounded shadow-xl items-center justify-center flex p">

            <div className="subcontent grid grid-cols-2 gap-x-4 ">
                <div className="subtext flex text-2xl font-bold rounded text-white items-center justify-center">
                    <h1> Fadlan Noo reeb Emailkaaga macmiil </h1>

                </div>
                <div className="subform bg-white p-4 flex items-center space-x-4">

                          <TextField sx={{backgroundColor: 'white', width:'250px'}} id="standard-basic" label="Email-kaaga Geli" variant="standard" />
                          <button className="bg-red-600 rounded px-11 py-3">Subscribe</button>
                </div>
