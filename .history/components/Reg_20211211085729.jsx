...
const Reg = () => {
    return (
        <div className="container flex flex-col items-center justify-center md:w-screen md:px-11 mb-36 ">
            ...
            <div className="flex flex-col items-center justify-center py-10 mt-24 bg-white rounded md:w-3/4 md:px-11 space-y-7 formcontainer">
            ...
            <div className="bg-white dark:bg-gray-800">
                ...
                <div className="container px-4 mx-auto mt-10 bg-white rounded dark:bg-gray-800">
                    <div className="py-5 border-b border-gray-300 xl:w-full dark:border-gray-700">
                        <div className="flex items-center w-11/12 mx-auto xl:w-full xl:mx-0">
                            <p className="text-lg font-bold text-gray-800 dark:text-gray-100">Personal Information</p>
                            <div className="ml-2 text-gray-600 cursor-pointer dark:text-gray-400">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={16} height={16}>
                                    <path className="heroicon-ui" d="M12 22a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0-9a1 1 0 0 1 1 1v4a1 1 0 0 1-2 0v-4a1 1 0 0 1 1-1zm0-4a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" fill="currentColor" />
                                </svg>
