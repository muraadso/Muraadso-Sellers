...
export default function Whatsell() {
  return (
      <>
    <div className="flex flex-col items-center md:justify-center justify-items-stretch tablle ">
            ...
            <TableContainer className="TableContainer" component={Paper} sx={{ padding: "12px", maxWidth: 1500, boxShadow: '2px 1px 11px rgba(0, 0, 0, 0.226)' }}>
