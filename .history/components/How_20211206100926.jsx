        ...
        <div className="mt-72 how mb-80">
            ...
            <div className="md:grid-cols-4 md:grid md:gap-x-4 gap-y-24 howsteps">
                ...
                <div className="relative max-h-full p-6 bg-white border-4 border-red-400 rounded how-card ">
                    ...
                    <div className="mb-4 text-xl text-gray-800 cardbody">
                        Iska diiwaan geli adeega 24h kadib waxad helaysa fariin ah in lagu aqbalay
                    </div>
                    <div className="absolute flex items-center justify-center w-10 h-10 text-red-500 bg-white border-2 border-red-500 rounded-full md:left-36 -bottom-4 md:left-40 left-36 place-content-center card-number"> <h2>1</h2></div>
                </div>
