  ...
  return (
    <div className="flex flex-col md:p-16 howtoreg mb-36">
      ...
      <div className="flex flex-col items-center justify-center space-y-3 md:space-x-24 md:flex-row acceptterms">
        ...
        <button className="items-center justify-center py-3 text-sm text-center text-white bg-red-600 text-stretch md:text-lg px-36 md:px-24 md:py-4 ">Register Now</button>
      </div>
