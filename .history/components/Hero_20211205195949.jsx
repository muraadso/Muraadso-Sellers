    ...
    return (
        <div className="md:grid-cols-2 md:grid md:mt-11 hero">
                <div className="md:px-16 md:py-36 py-11 herotxt">
                    ...
                    <p className="text-center text-gray-700 md:text-left" >Whether you’ve already got an established ecommerce business, a great idea for a new product, or you just have a passion for selling, here’s how to take that next step with Muraadso</p>
                </div>
