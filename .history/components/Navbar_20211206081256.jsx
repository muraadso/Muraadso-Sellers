    ...
    <nav className="sticky top-0 z-20 items-center justify-between md:bg-white px-14 md:px-24 md:py-5 navbar md:flex">
      ...
      <ul
        className={
          ...
          " md:static fixed bottom-0 md:ml-24 top-14 md:flex md:space-x-6 items-center md:bg-transparent md:bg-white bg-opacity-90 md:w-auto w-10/12 md:text-gray-800 text-gray-800  md:space-y-0 space-y-5 p-2 transition-left nav"
        }
      >
        <a href="#"> Home</a>
        <a href="#"> About</a>
