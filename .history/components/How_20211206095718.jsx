    ...
    return (
        <div className="mt-72 how mb-80">
            ...
            <div className="md:grid-cols-4 md:grid md:gap-x-4 gap-y-24 howsteps">
                ...
                <div className="relative max-h-full p-6 bg-white border-2 border-red-500 rounded w-xl how-card ">
                    <div className="flex items-center justify-center m-y-4 card-icon ">
                        <img  src="./icons/register.png" alt="register" />
                        
                    </div>
                    <div className="mb-4 cardbody">
