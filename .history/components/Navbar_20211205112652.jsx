const Navbar = () => {
  ...
  <div className="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row">
    ...
    <button className="inline-flex items-center px-3 py-1 mt-4 text-base text-white bg-red-600 border-0 rounded focus:outline-none hover:bg-red-700 md:mt-0">Button   </button>
  </div>
</header>
