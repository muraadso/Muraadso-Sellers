...
const Reg = () => {
    return (
        <div className="container flex flex-col items-center justify-center md:w-screen md:px-11 mb-6 ">
            ...
            <h1 className="text-lg font-bold text-center md:text-3xl ">Is Diiwaan Geli</h1>
                ...
                <div className="flex flex-col items-center justify-center text-center">
                    <FormControlLabel className="mb-2" control={<Checkbox />} label="I accept the privacy and policy" />
                   <button
