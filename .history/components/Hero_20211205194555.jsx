const Hero = () => {
    return (
        <div className="grid-colmd:s-2 md:grid md:mt-11 hero">
                <div className="md:px-16 py-36 herotxt">
                    <h6 className="px-2 font-medium text-gray-500">ku iibi muraadso</h6>
                    <h1 className="md:my-5 md:font-bold md:text-gray-800 md:capitalize lg:text-6xl">sidee ugu iibin krtaa <br /> alaabtaada <span className="md:text-red-600">muraadso </span></h1>
