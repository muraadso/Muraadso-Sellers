...
export default function Whatsell() {
  return (
      <>
    <div className="flex flex-col items-center justify-center tablle ">
            ...
            <TableContainer className="TableContainer" component={Paper} sx={{ padding: "12px", maxWidth: 1100, boxShadow: '2px 1px 11px rgba(0, 0, 0, 0.226)' }}>
