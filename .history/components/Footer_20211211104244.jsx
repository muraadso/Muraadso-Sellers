    ...
    return (
        <div className="px-24 py-16 border bg-gray-50 space-y-7">
            ...
            <div className="footericons space-x-7">
                <FacebookIcon sx={{ fontSize: 30, backgroundColor: "#ff0000" }} />
                <InstagramIcon sx={{ fontSize: 30, backgroundColor: "#ff0000" }} />
                <YouTubeIcon sx={{ fontSize: 30, backgroundColor: "#ff0000" }} />
            </div>
