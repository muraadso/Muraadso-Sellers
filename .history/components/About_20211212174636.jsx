...
const About = () => {
    ...
    element="span"
    truncateText="…"
    text="Lorem Ipsum is simply dummy text of the printing and typesetting industry                         Muraadso waa hogaanka suuqa casriga ee online waana suuq aad ku iibin kartid alaabtaada, ahaw ganacsade alaabta sameeya, mid soo dajiya, si fudud ayaad ugu iibin kartaa suuqa casriga muraadso, sidoo kale ka mid noqo ganacsiyada shabakada internet ku iibiya alaabaha adiga oon ku kharash badan galin, kana faa’idaysanaya khubarada team ka muraadso helayana tobabaro iyo caawimo sidaad ugu iibin lahayd muraadso dhexdeeda Ku dhex iibta muraadso waa wax fudud sidoo kalena kharash yari kaaga bixi karo ama wax kharash ahi kaa baxayn, kaliya waxa lagaaga bahanyay in aad is diwaan galisid, kuna gurtid alaabta aad haysid online shirkada sidaana aad ku bilawdid iibka alaabtaada....<span className="text-red-600">Read More</span>
."
