    ...
    return (
     ...
     <div className="flex items-center justify-between w-full px-24 py-6 navbar ">
         ...
         <nav className="flex items-center justify-between w-1/4 nav">
             <a className="hover:bg-red-600" href="">Home</a>
             <a className="hover:bg-red-600" href="">About</a>
             <a className="hover:bg-red-600" href="">Doc</a>
             <a className="hover:bg-red-600" href="">Contact Us</a>
         </nav>
