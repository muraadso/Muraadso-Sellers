                            ...
                            <div className="flex w-full lg:w-1/2">
                                ...
                                <div className="flex flex-col justify-between w-full px-6 lg:w-1/2">
                                    ...
                                    <div className="relative w-36">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 m-auto mr-3 text-gray-700 pointer-events-none dark:text-gray-50 icon icon-tabler icon-tabler-chevron-down" width={16} height={16} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                            <polyline points="6 9 12 15 18 9" />
                                        </svg>

                                        <select value={mode} onChange={(e) => setMode(e.target.value)} className="flex items-center w-full h-12 py-2 pl-10 text-sm leading-5 border border-gray-700 rounded appearance-none focus:outline-none dark:border-gray-50 dark:bg-gray-900 dark:text-gray-50">
