...
const Reg = () => {
    return (
        <div className="container flex flex-col items-center justify-center w-full md:px-16 mb-36 ">
            ...
            <h1 className="text-lg font-bold text-center md:text-3xl mb-11 ">Is Diiwaan Geli</h1>
            <p>Iska diiwaan geli form-ka hoos kaaga muuqda </p>
                ...
                <div className="flex flex-col items-center justify-center text-center">
                    <FormControlLabel control={<Checkbox defaultChecked />} label="I accept the privacy policy" />
                   <button
