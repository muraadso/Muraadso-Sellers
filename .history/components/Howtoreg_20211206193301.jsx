...
export default function Howtoreg() {
  return (
    ...
    <div className="flex flex-col items-center justify-center tablle2 mb-36">
            <h1 className="text-2xl font-bold text-center md:text-3xl">Alaab Nocee ah ayaadan iibin karin ?</h1>
            <p className="max-w-3xl text-lg text-center text-gray-600">Dhamaan alaabta hoos ku xusan ma aha alaab laga ogol yahay shirkadda 
