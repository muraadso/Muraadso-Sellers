...
const rows = [
  ...
  createData('Mobiles', 'Samsung, Redmi, apple, lenova ', 'New / Used'),
  createData('Laptops', 'hp, acer, apple, lenova ', 'New / Used'),
  createData('Laptops', 'hp, acer, apple, lenova ', 'New / Used'),
  createData('Laptops', 'hp, acer, apple, lenova ', 'New / Used'),
  createData('Laptops', 'hp, acer, apple, lenova ', 'New / Used'),
  createData('Laptops', 'hp, acer, apple, lenova ', 'New / Used'),
  createData('Laptops', 'hp, acer, apple, lenova ', 'New / Used'),
  createData('jd', 'hp, acer, apple, lenova ', 'New / Used'),
...
export default function Whatsell() {
  return (
    ...
    <div className="flex flex-col items-center md:justify-center tablle ">
            ...
            <TableContainer className="mw-screen-lg TableContainer" component={Paper} sx={{ padding: "15px", minWidth: 370 , maxWidth: 1500, boxShadow: '2px 1px 11px rgba(0, 0, 0, 0.226)' }}>
        <h1 className="mb-6 text-2xl font-bold "> <span className="font-black text-red-500 ">|</span> Noocyada Alaabta</h1>
      <Table sx={{ minWidth: 500 }} aria-label="customized table">
        <TableHead>
          <TableRow>
