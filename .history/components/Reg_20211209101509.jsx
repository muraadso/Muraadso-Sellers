...
const Reg = () => {
    return (
        <div className="container flex flex-col items-center justify-center w-full md:px-16 mb-36 ">
            ...
            <div className="flex flex-col items-center justify-center px-2 py-10 mt-24 bg-white rounded md:w-3/5 md:px-11 formcontainer">
            <h1 className="text-lg text-center md:text-3xl mb-11 ">Is Diiwaan Geli</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 bg-gray-500 gap-y-7 form">
