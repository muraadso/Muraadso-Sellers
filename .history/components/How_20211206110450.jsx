export const How = () => {
    return (
        <div className="flex flex-col items-center justify-center mt-24 mb-24 how md:gap-y-7 gap-y-11">
            ...
            <div className="h-full md:p-16 md:gap-4 gap-72 md:grid-cols-4 md:grid howsteps">
                ...
                <div className="relative max-h-full p-6 mb-5 bg-white border-4 border-red-400 rounded how-card ">
