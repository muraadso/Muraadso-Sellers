...
export default function Howtoreg() {
  return (
    ...
    <div className="flex flex-col items-center justify-center tablle mb-36">
                <h1>Alaab Nocee ah ayaad iibin kartaa ?</h1>
                <p>Waxay ku xirantahy alaabta noceeda, xaaladda alaabta, Category-ga, iyo Brand-ka .
    ...
    <div className="flex flex-col items-center justify-center tablle2 mb-36">
            <h1 className="text-xl font-bold text-center md:text-3xl">Alaab Nocee ah ayaadan iibin karin ?</h1>
            <p className="max-w-3xl text-center text-gray-600 text-medium md:text-lg">Dhamaan alaabta hoos ku xusan ma aha alaab laga ogol yahay shirkadda 
