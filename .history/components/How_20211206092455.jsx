        ...
        <div className="mt-72 how mb-80">
            ...
            <div className="grid grid-cols-4 howsteps">
                ...
                <div className="relative p-5 bg-white border-2 border-red-500 rounded w-2xl how-card ">
                    ...
                    <div className="absolute flex items-center justify-center w-10 h-10 text-red-500 bg-white border-2 border-red-500 rounded-full left-5 place-content-center card-number"> <h2>1</h2></div>
                </div>
