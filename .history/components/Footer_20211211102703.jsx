...
const Footer = () => {
    return (
        ...
        <div className="border bg-gray-50 space-y-7 footer">
            ...
            <svg className="w-screen -z-50 wave " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 920"><path fill="#ff0000" fillOpacity="0.07" d="M0,192L60,197.3C120,203,240,213,360,202.7C480,192,600,160,720,170.7C840,181,960,235,1080,240C1200,245,1320,203,1380,181.3L1440,160L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z"></path></svg>
