...
const Footer = () => {
    return (
        <div className="px-2 border md:px-24 md:py-16 bg-gray-50 space-y-7">
            <div className="flex flex-col items-center justify-between md:flex-row upper">

            <div className="flex items-center space-x-5 md:space-x-7 space-y-7 justify-items-start footercontent">
                <a href="#">About Us</a>
