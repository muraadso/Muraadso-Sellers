...
const Footer = () => {
    return (
        <> 
        <div className="subscribe items-center justify-center flex ">
            <div className="subcontainer bg-red-500 md:w-3/4 p-16 rounded shadow-xl items-center justify-center flex">
