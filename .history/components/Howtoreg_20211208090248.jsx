...
const Howtoreg = () => {
  return (
    <div className="flex flex-col md:p-16 howtoreg">
      ...
      <div className="flex flex-col items-center justify-center space-x-24 md:space-y-3 md:flex-row acceptterms">
        <div className="flex flex-row items-center justify-center space-x-2 check">
        <input type="checkbox" />
        <h2>I accpet the terms and cuntinue to register</h2>
        </div>
        <button className="py-3 text-white bg-red-600 tex px-36 md:px-24 md:py-5 ">Is Diiwaan Geli</button>
      </div>
