const Navbar = () => {
  ...
  <div className="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row">
    ...
    <nav className="flex flex-wrap items-center justify-center text-base md:ml-auto">
      <a className="mr-5 hover:text-red-600">First Link</a>
      <a className="mr-5 hover:text-red-600">Second Link</a>
      <a className="mr-5 hover:text-red-600">Third Link</a>
      <a className="mr-5 hover:text-red-600">Fourth Link</a>
    </nav>
