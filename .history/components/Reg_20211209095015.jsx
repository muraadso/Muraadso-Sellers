...
const Reg = () => {
    return (
        <div className="container px-16 mb-36 ">
            ...
            <div className="flex flex-col items-center justify-center px-24 py-10 bg-white rounded formcontainer">
            <h1 className="text-lg text-center md:text-3xl mb-11 ">Nagu Soo Biir Macmiil</h1>
