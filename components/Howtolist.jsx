...
u diiwaan gelisid ay uga soo muuqato Bogga MURAADSO</p>
      ...
      <div className="flex flex-col items-center justify-center space-y-6 watch">
          <h1 className="text-lg font-medium text-center md:font-bold md:text-xl ">Ama Daawo Video-gan Kuu Sharaxaya Habka looso geliyo Product</h1>
         <div className='flex items-center justify-center w-screen p-2 overflow-x-hidden mx-11 player-wrapper'>
        <ReactPlayer
